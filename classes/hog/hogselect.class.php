...
namespace Hog {
    ...
    class HogSelect extends Hog
    {
        ...
        public function getIfWordBanned(string $name):bool
        {
            return $this->returnIfWordBanned($name);
        }

        public function getIfIpBanned(string $ipAddr):bool
        {
            return $this->returnIfIpBanned($ipAddr);
        }
