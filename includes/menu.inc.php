...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
    ...
    <a class="navbar-brand mx-auto" href="<?php echo $actual_link;?>"><b>Hog Players</b></a>
    ...
    <div class="collapse navbar-collapse w-100 order-1 order-md-0 dual-collapse2" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto">
            <li class="nav-item">
                <a class="nav-link" href="mailto:development@oceqs.com">
                    Reach out -> development@oceqs.com |
                </a>
            </li>
            <li class="nav-item">
